...
RuneSolverNode::RuneSolverNode(const rclcpp::NodeOptions &options) : Node("rune_solver", options) {
  FYT_REGISTER_LOGGER("rune_solver", "qd2026-log", INFO);
...
RCLCPP_COMPONENTS_REGISTER_NODE(qd::rune::RuneSolverNode)
