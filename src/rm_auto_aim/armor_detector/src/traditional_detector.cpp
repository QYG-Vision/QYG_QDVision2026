...
std::vector<Armor> TraditionalDetector::detect(const cv::Mat& input) noexcept {
...
cv::Mat TraditionalDetector::preprocessImage(const cv::Mat& rgb_img) noexcept {
...
std::vector<Light>
TraditionalDetector::findLights(const cv::Mat& rgb_img, const cv::Mat& binary_img) noexcept {
    using std::vector;
...
bool TraditionalDetector::isLight(const Light& light) noexcept {
...
std::vector<Armor> TraditionalDetector::matchLights(const std::vector<Light>& lights) noexcept {
...
ArmorType TraditionalDetector::isArmor(const Light& light_1, const Light& light_2) noexcept {
...
cv::Mat TraditionalDetector::getAllNumbersImage() const noexcept {
    if (armors_.empty()) {
...
void TraditionalDetector::drawResults(cv::Mat& img) const noexcept {
    // Draw Lights
