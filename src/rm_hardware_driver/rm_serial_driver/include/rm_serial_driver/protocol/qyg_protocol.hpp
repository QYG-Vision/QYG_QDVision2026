...
static_assert(offsetof(QygReceiveFrame, imu_yaw) == 15, "Invalid imu_yaw offset");
static_assert(offsetof(QygReceiveFrame, imu_pitch) == 19, "Invalid imu_pitch offset");
static_assert(offsetof(QygReceiveFrame, yaw_angular) == 23, "Invalid yaw_angular offset");
static_assert(offsetof(QygReceiveFrame, pitch_angular) == 27, "Invalid pitch_angular offset");
static_assert(offsetof(QygReceiveFrame, odom_x) == 31, "Invalid odom_x offset");
static_assert(offsetof(QygReceiveFrame, sentry_state) == 35, "Invalid sentry_state offset");
static_assert(offsetof(QygReceiveFrame, vyaw) == 37, "Invalid vyaw offset");
static_assert(offsetof(QygReceiveFrame, vpitch) == 41, "Invalid vpitch offset");
static_assert(offsetof(QygReceiveFrame, vroll) == 45, "Invalid vroll offset");
static_assert(offsetof(QygReceiveFrame, crc16) == 49, "Invalid receive CRC offset");
